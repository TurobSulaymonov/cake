...
// TODO: Compare password
  ...
  const isMatch = await this.authService.comporePasswords(input.memberPassword, response.memberPassword)
...
public async memberUpdate(memberId: ObjectId, input: MemberUpdate): Promise<Member> {
...
public async memberStatsEditor (input: StatisticModifier): Promise<Member> {
  ...
  return await this.memberModel.findOneAndUpdate(_id, 
