...
export class NotificationService {
	...
	public async createContactMessage(memberId: ObjectId, input: ContactInput): Promise<void> {
		...
		const notification = new this.notificationModel({
			...
			notificationDesc: ` You have a new message regarding your property ${title.productName} : Name: ${input.name}, Phone: ${input.phone}, Email: ${input.email},  Message: ${input.message}.`,
			authorId: memberId,
